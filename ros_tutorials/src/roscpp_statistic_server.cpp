...
class AveragingAction
{
    private:
        ros::NodeHandle nh_;
        actionlib::SimpleActionServer<ros_tutorials::AveragingAction> as_;
        std::string action_name_;
        int data_count_, goal_;
        float sum_, sum_sq_;
        ros_tutorials::AveragingFeedback feedback_;
        ros_tutorials::AveragingResult result_;
        ros::Subscriber sub_;
    public:
...
{
    ros::init(argc, argv, "statistic_server");
    AveragingAction averaging("statistic");
    ros::spin();
